...
"""Memory management — ownership, interior mutability, and smart pointers.

Provides Box, Rc, Weak, Arc, Cell, RefCell, OnceCell, Lazy, Cow,
Pin, ManuallyDrop, MaybeUninit, NonNull, PhantomData, Borrow, BorrowMut.
"""
